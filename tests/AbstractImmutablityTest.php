<?php
abstract class AbstractImmutabilityTest extends \PHPUnit_Framework_TestCase
{
    abstract protected function newServerRequest();

    protected function setUp()
    {
        $this->request = $this->newServerRequest();
    }
